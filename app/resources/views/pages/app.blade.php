...
<div class="hero-full-container background-image-container white-text-container">
    <div class="container">
      <div class="row">
        <div class="col-xs-12">
          <h1>Slack 2 Gmail</h1>
          <p>Synchronize and backup Slack channels into Gmail</p>
          <br/>
          <a href="/join" class="btn btn-default btn-lg" title="Subscribe">Get Started</a>
        </div>
      </div>
    </div>
  </div>
            ...
            <div id="carousel-example-generic" class="carousel carousel-fade slide" data-ride="carousel">
                ...
                <div class="carousel-inner" role="listbox">
                    ...
                    <div class="item active">
                        <img class="img-responsive" src="" alt="First slide">
    ...
    <div class="container text-center">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-4">
          <img src="" alt="" class="reveal img-responsive reveal-content image-center">
          <h3>John Snow</h3>
          <h4>UX designer</h4>
  ...
  <div class="section-container">
    <div class="container text-center">
      ...
      <div class="row">
        <div class="col-xs-12 col-md-4">
          <img src="" alt="" class="img-responsive reveal-content image-center">
